"""think152_30709 URL Configuration
...
admin.site.site_header = "Think152"
admin.site.site_title = "Think152 Admin Portal"
admin.site.index_title = "Think152 Admin"

# swagger
api_info = openapi.Info(
    title="Think152 API",
    default_version="v1",
    description="API documentation for Think152 App",
)
